...
exports.addShowtime = async (req, res, next) => {
    let showtime= new Showtime(null, req.body.time_start, req.body.time_finish, req.body.movie_id)
    try{
...
exports.editShowtime = async (req, res, next) => {
    let showtime = new Showtime(req.params.id, req.body.time_start, req.body.time_finish, req.body.movie_id)
    try{
