...
class Movie{
    constructor(movie_id, movie_name, movie_type, viewer, movie_length, movie_image, movie_status, admin_id){
    ...
    async addMovie(){
        ...
        try{
            let stmt = 'insert into MOVIE (movie_name, movie_type, viewer, movie_length, movie_image, movie_status, admin_id) values(?, ?, ?, ?, ?, ?, ?);'
            let keep = await conn.query(stmt, [this.movie_name, this.movie_type, this.viewer, this.movie_length, this.movie_image, this.movie_status, this.admin_id])
    ...
    async editMovie(){
        ...
        try{
            ...
            console.log(conn.query(stmt, [this.movie_name, this.movie_type, this.movie_length, this.movie_image, this.movie_status, this.movie_id]))
